...
define(['jquery', 'mustache', 'app/prototype/user', 'text!app/views/detail.html', 'text!app/views/404.html'], function($, Mustache, User, template, error404) {
    ...
    if (seed) {
        user = new User(seed, userCallback);
        user.getUser();
    } else {
        $userDetail.append(
